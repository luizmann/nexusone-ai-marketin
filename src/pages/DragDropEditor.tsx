    ...
    <div className="min-h-screen bg-background">
      <div className="flex">
        ...
        <div className="flex-1 p-4">
          <div className="bg-white border rounded-lg min-h-[600px] relative">
            {elements.map((element) => (
              <div
                key={element.id}
                className={`absolute border ${selectedElement?.id === element.id ? 'border-blue-500' : 'border-gray-300'} rounded cursor-move`}
                style={{
                  left: element.x,
                  top: element.y,
                  width: element.width,
